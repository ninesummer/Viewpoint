  ...
  module EWS
    module ItemFieldUriMap
      ...
      FIELD_URIS= {
        ...
        :physical_addresses  => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddresses', :writable => true},
        :street => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:Street', :writable => true },
        :city => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:City', :writable => true},
        :state => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:State', :writable => true},
        :postal_code => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:PostalCode', :writable => true},
        :country_or_region => {:ftype => :indexed_field_uRI, :text => 'contacts:PhysicalAddress:CountryOrRegion', :writable => true},
